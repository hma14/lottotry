<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="RenewMembership.aspx.cs" Inherits="Lottotry.Members.RenewMembership" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="cphcontent" runat="server">
    ...
    <p style="font-size:small;"><asp:Label class="star" runat="server" Text="*"></asp:Label>Indicates required field. <br />
    ...
    <table cellpadding="0" cellspacing="0" width="650" style="margin-left:10px" >
            ...
            <tr>
                ...
                <td>
                    <div>
                        ...
                        <asp:Label ID="Label1" class="star" runat="server" Text=" * " />
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    onclick="jAlert('1 month for <em>$4.99</em>\n\n6-month for <em>$24.99</em> (regular price: <strike>$29.99</strike>), saving <em>1</em> month\n\n12-month for <em>$44.99</em> (regular price: <strike>$59.99</strike>), saving <em>3</em> months', 'Membership Plans:');" 
            ...
            <tr>
                <td>
                    <div style="float:left;">
                        <asp:Button ID="btnReset" class="buttons" runat="server" onclick="btnReset_Click" SkinID="buttonSkin" TabIndex="9" Text="Reset" />
                    </div>
                </td>
                <td>
